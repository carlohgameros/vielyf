...
class Home extends Component {
  constructor(props) {
    ...
    this.onTextBoxChangeSignUpLicense = this.onTextBoxChangeSignUpLicense.bind(
      this
    );
    this.onTextBoxChangeSignUpProfFirstName = this.onTextBoxChangeSignUpProfFirstName.bind(
      this
    );
    this.onTextBoxChangeSignUpProfLastName = this.onTextBoxChangeSignUpProfLastName.bind(
      this
    );
    this.onTextBoxChangeSignUpProfMotherLastName = this.onTextBoxChangeSignUpProfMotherLastName.bind(
      this
    );
    this.onTextBoxChangeSignUpProfTitle = this.onTextBoxChangeSignUpProfTitle.bind(
      this
    );
    this.onTextBoxChangeProfEmail = this.onTextBoxChangeProfEmail.bind(this);
    this.onTextBoxChangeProfPassword = this.onTextBoxChangeProfPassword.bind(
      this
    );
    this.onTextBoxChangeCorpAUpFirstName = this.onTextBoxChangeCorpAUpFirstName.bind(
      this
    );
    this.onTextBoxchangeCorpAUpLastName = this.onTextBoxchangeCorpAUpLastName.bind(
      this
    );
    this.onTextBoxChangeFatFreeBodyMassBodyFat = this.onTextBoxChangeFatFreeBodyMassBodyFat.bind(
      this
    );
    ...
    this.onTextBoxChangeFatFreeBodyMass = this.onTextBoxChangeFatFreeBodyMass.bind(
      this
    );
    this.onTextBoxChangeFatFreeBodyMassBodyFat = this.onTextBoxChangeFatFreeBodyMassBodyFat.bind(
      this
    );
    this.onTextBoxChangeLeanSoftTissue = this.onTextBoxChangeLeanSoftTissue.bind(
      this
    );
    ...
    this.onTextBoxChangeTotalBodyWater = this.onTextBoxChangeTotalBodyWater.bind(
      this
    );
   ...
   */
    const URL =
      "http://search.sep.gob.mx/solr/cedulasCore/select?fl=%2A%2Cscore&q=" +
      License +
      "&start=0&rows=100&facet=true&indent=on&wt=json";
    if (License != "" || !License) {
      fetch(URL, {
        method: "GET",
        crossDomain: true
  ...
  onProfSignUp() {
    const { profFirstName, profLastName, profEmail, profPassword } = this.state;
    console.log(profFirstName, profLastName, profEmail, profPassword);
    this.setState({
      isLoading: true
    });
          ...
          <div>
            ...
            >
              <input
                ...
                value={License}
                onChange={this.onTextBoxChangeSignUpLicense}
              />{" "}
              <button onClick={() => this.verify()}>Verificar</button>
              <br />
              <input
                type="text"
                placeholder="Nombre"
                value={profFirstName}
                onChange={this.onTextBoxChangeSignUpProfFirstName}
                readOnly
              />
              <br />
              <input
                ...
                placeholder="Paterno"
                value={profLastName}
                onChange={this.onTextBoxChangeSignUpProfLastName}
                readOnly
              />
              <br />
              <input
                ...
                onChange={this.onTextBoxChangeSignUpProfMotherLastName}
                readOnly
              />
              <br />
              <input
                ...
                placeholder="Titulo"
                value={profTitle}
                onChange={this.onTextBoxChangeSignUpProfTitle}
                readOnly
              />
              <br />
              <input
                ...
                placeholder="email"
                value={profEmail}
                onChange={this.onTextBoxChangeProfEmail}
              />
              <br />
              <input
                type="password"
                placeholder="password"
                value={profPassword}
                onChange={this.onTextBoxChangeProfPassword}
              />
              <br />
    ...
    return (
      <div>
        ...
        <input
          ...
          placeholder="First Name"
          value={corpFirstname}
          onChange={this.onTextBoxChangeCorpAUpFirstName}
        />
        <input
          type="text"
          placeholder="Last  Name"
          value={corpLastName}
          onChange={this.onTextBoxchangeCorpAUpLastName}
        />
        <input
          type="text"
          placeholder={id}
          value={id}
          onChange={this.onTextBoxChangeId}
        />
        <br />
        <input
          type="text"
          placeholder="Height"
          value={height}
          onChange={this.onTextBoxChangeHeight}
        />
        <br />
        <input
          type="text"
          placeholder="Weight"
          value={weight}
          onChange={this.onTextBoxChangeWeight}
        />
        <input
          type="text"
          placeholder="Age"
          value={Age}
          onChange={this.onTextBoxChangeAge}
        />
        <div className="container">
          <div className="row">
            ...
            <div>
              <input
                type="text"
                className="p-3 mb-5 bg-success text-white"
                placeholder="Fat-Free Body Mass"
                value={FatFreeBodyMass}
                onChange={this.onTextBoxChangeFatFreeBodyMass}
              />
            </div>
            <div className="col-8">
              <input
                type="text"
                className="p-3 mb-5 bg-success text-white"
                placeholder="FFBM Body Fat"
                value={FFBMBodyFat}
                onChange={this.onTextBoxChangeFatFreeBodyMassBodyFat}
              />
            </div>
            <div>
              <input
                type="text"
                className="p-3 mb-5 bg-success text-white"
                placeholder="Lean Soft Tissue"
                value={LeanSoftTissue}
                onChange={this.onTextBoxChangeLeanSoftTissue}
              />
            </div>
            <div>
              <input
                ...
                placeholder="Mineral"
                value={LSTMineral}
                onChange={this.onTextBoxChangeLSTMineral}
              />
            </div>
            <div className="col-6">
              <input
                ...
                value={LSTBodyFat}
                onChange={this.onTextBoxChangeLSTBodyFat}
              />
            </div>
            <div>
              <input
                ...
                onChange={this.onTextBoxChangeTotalBodyWater}
              />
            </div>
            <div>
              <input
                ...
                placeholder="Protein"
                value={TBWProtein}
                onChange={this.onTextBoxChangeTBWProtein}
              />
            </div>
            <div>
              <input
                ...
                placeholder="Mineral"
                value={TBWMineral}
                onChange={this.onTextBoxChangeTBWMineral}
              />
            </div>
            <div>
              <input
                ...
                placeholder="Body Fat"
                value={TBWBodyFat}
                onChange={this.onTextBoxChangeTBWBodyFat}
              />
            </div>
          </div>
